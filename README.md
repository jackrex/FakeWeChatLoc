...
执行
```
./pic/class-dump -H WeChat.decrypted --arch armv7  -o output/
```
...
```
#!/bin/bash
find ./pic/Package -name ".DS_Store" -depth -exec rm {} \;
